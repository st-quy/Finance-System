...
import { Layout, Table, Typography, Card, Button, Space, Modal, message, Input, Form, Select, DatePicker } from "antd";
import { EyeOutlined, DeleteOutlined, SearchOutlined, PlusOutlined, EditOutlined } from "@ant-design/icons";
...
const [filters, setFilters] = useState({ projectType: null, startDate: null, endDate: null, inProcess: null });
...
const fetchProjects = async (query = "", filters = {}) => {
  ...
  if (query) {projects = projects.filter((project) =>
  ...
  if (filters.startDate && filters.endDate) {
    projects = projects.filter(
      (project) => new Date(project.start_date) >= new Date(filters.startDate) && new Date(project.end_date) <= new Date(filters.endDate));
}
